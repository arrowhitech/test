package com.aht.test.repository;

import com.aht.test.TestApp;
import com.aht.test.config.Constants;
import com.aht.test.config.audit.AuditEventConverter;
import com.aht.test.domain.PersistentAuditEvent;
...
import static com.aht.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
